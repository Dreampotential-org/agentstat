    ...
    <div class="toc-two-left-two">
      <div class="toc-two-left-two-heading">
        ...
        <div class="toc-two-left-two-heading-right">
          <span  class="unpin">
                                                                        <a href="#" data-rel="pin-state" class="pin-state" id="pin-state"><i class="fas fa-thumbtack" aria-hidden="true"></i></a>
                                                                        <p>Unpin</p>
                                                                    </span>
                                                                    <span  class="pin" style="display: none">
                                                                        <a href="#" id="unpin-state"><img src="img/push-pin.png" width="30px"></a>
                                                                        <p>Pin to the top</p>
                                                                    </span>
        </div>
      </div>
